...
{
	g_iNSFWDecalIndex = PrecacheDecal("decals/spraymanager/1.vtf", true);
	g_iHiddenDecalIndex = PrecacheDecal("decals/spraymanager/2.vtf", true);
	g_iTransparentDecalIndex = PrecacheDecal("decals/spraymanager/3.vtf", true);
}
